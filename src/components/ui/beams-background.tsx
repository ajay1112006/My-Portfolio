...
export function BeamsBackground({
  ...
  const opacityFactor = opacityMap[intensity];
  ...
  useEffect(() => {
    ...
    function drawBeam(context: CanvasRenderingContext2D, beam: Beam) {
      ...
      gradient.addColorStop(0, `hsla(0, 0%, 80%, 0)`);
      gradient.addColorStop(0.1, `hsla(0, 0%, 80%, ${pulsingOpacity * 0.5})`);
      gradient.addColorStop(0.4, `hsla(0, 0%, 80%, ${pulsingOpacity})`);
      gradient.addColorStop(0.6, `hsla(0, 0%, 80%, ${pulsingOpacity})`);
      gradient.addColorStop(0.9, `hsla(0, 0%, 80%, ${pulsingOpacity * 0.5})`);
